...
class VendingMachine(QMainWindow):
    ...
    def initUI(self):
        ...
        # Set default size to 80% of screen
        self.resize(width, height)
        
        # Set minimum and maximum sizes
        self.setMinimumSize(1024, 768)  # Minimum size for comfortable viewing
        self.setMaximumSize(1920, 1080)  # Full HD maximum
        ...
        # Make water widget responsive
        self.water_widget.setMinimumSize(300, 400)
        self.water_widget.setMaximumSize(500, 600)
        self.water_widget.setSizePolicy(QSizePolicy.Preferred, QSizePolicy.Expanding)
